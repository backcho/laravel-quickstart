...
| 기능 | Laravel | Next.js |
|------|---------|---------|
| 인증 | `laravel/ui` 한 줄 | NextAuth + 설정 지옥 |
...
| 스케줄링 | Task Scheduling 내장 | 없음 (Vercel Cron 등 필요) |
| 파일 업로드 | Storage 파사드 내장 | S3 직접 연동 |
...
- 저렴하고 다양한 호스팅 옵션
- 방대한 레퍼런스와 커뮤니티
- Composer를 통한 성숙한 패키지 생태계

## 문서 목차

1. [PHP 개발환경 준비](./01_php_개발환경_준비.md)
2. [프로젝트 설치/생성](./02_프로젝트_설치_생성.md)
3. [예제: 서비스 (인증 + 게시판)](./03_예제_서비스.md)
4. [예제: 백오피스 (RBAC + 회원관리 + 통계)](./04_예제_백오피스.md)
5. [서비스 공개 (ngrok)](./05_서비스공개.md)
6. [보너스: UI 커스텀](./06_보너스_UI커스텀.md)
...
[01_php_개발환경_준비.md](./01_php_개발환경_준비.md)부터 순서대로 따라오세요!
