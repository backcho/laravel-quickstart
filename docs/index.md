...
1. [PHP 개발환경 준비](./01-php-개발환경-준비)
2. [프로젝트 설치/생성](./02-프로젝트-설치-생성)
3. [바이브코딩: 게시판 + 백오피스](./03-바이브코딩-예제)
4. [서비스 공개 (ngrok)](./04-서비스공개)
5. [보너스: UI 커스텀](./05-보너스-UI커스텀)
...
[01. PHP 개발환경 준비](./01-php-개발환경-준비)부터 순서대로 따라오세요!
